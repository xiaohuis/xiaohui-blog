...
public class CheckCodeUtil {
    ...
    public static void main(String[] args) throws IOException {
        OutputStream fos = new FileOutputStream("d://blog_idea/xiaohui_blog/src/main/webapp/static/admin/images/a.jpg");
        String checkCode = CheckCodeUtil.outputVerifyImage(50, 30, fos, 4);
    }
